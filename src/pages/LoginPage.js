    ...
    <div>
      <div className="Signup-pics h-screen w-screen text-[white] ">
        ...
        <div className="login-img w-full h-full flex justify-center items-center ">
          <div className="signup-form md:max-w-lg w-[90%] h-5/6 bg-glass py-6 px-4 flex flex-col justify-around items-center shadow">
            ...
            <div className="input-group flex items-center w-full justify-around md:text-lg px-9"><label htmlFor="username">User Name</label><input type="text" className='w-[70%] text-base rounded bg-glass px-3 py-3 text-[#000]'/></div>
            <div className="input-group flex items-center w-full justify-around md:text-lg px-9"><label htmlFor="password">Password</label><input type="password" className='w-[70%] text-base rounded bg-glass px-3 py-3 text-[#000]'/></div>
