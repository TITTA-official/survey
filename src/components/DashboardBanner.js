...
function DashboardBanner({name, role}) {
  return (
    <div className="banner mt-16 w-full mx-auto flex flex-col justify-center items-center gap-2 md:gap-4">
        ...
        <div className="sub-inf text-sm md:text-base font-light">{` ${ role === 'admin'  ? 'Admin Page' : 'To get started, you can take a survey'} `}</div>
